...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4 max-w-6xl">
        ...
        @if($has_custom_gambar)
            {{-- TAMPILAN GAMBAR POSTER A4 SAJA (TEKS DISEMBUNYIKAN) --}}
            <div class="max-w-2xl mx-auto reveal">
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-4 md:p-6 overflow-hidden mb-8">
                    <img src="{{ Storage::url($gambar) }}" alt="Maklumat Pelayanan {{ $nama_rs }}"
                         class="w-full aspect-[210/297] object-contain rounded-2xl shadow-sm border border-gray-100 bg-white">
                </div>

                <div class="p-5 rounded-xl border-l-4 border-gold shadow-sm bg-white" style="background-color: #fffbeb">
        ...
        @else
            {{-- TAMPILAN DUA KOLOM STANDAR (GAMBAR KIRI, TEKS KANAN) --}}
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">

                {{-- KIRI: Foto RS --}}
                <div class="photo-deco relative reveal">
                    @if($gambar)
                ...
                <div class="reveal">
                    ...
                    <div class="mt-8 p-5 rounded-xl border-l-4 border-gold bg-white" style="background-color: #fffbeb">
                        <p class="text-dark text-sm">
                            <i class="fas fa-info-circle text-gold mr-1"></i>
                            Apabila pelayanan kami tidak sesuai maklumat ini, sampaikan melalui
                            <a href="{{ route('layanan.pengaduan') }}" class="text-primary font-semibold hover:underline">kanal pengaduan</a>.
