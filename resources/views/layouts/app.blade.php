...
<head>
    ...
    <!-- Google Fonts -->
    <link
        href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@500;600;700;800&family=Source+Sans+3:wght@300;400;600&display=swap"
        rel="stylesheet">
...
<body class="bg-white text-gray-800">
    ...
    <button id="back-to-top"
        class="hidden fixed bottom-6 right-6 bg-primary text-white w-12 h-12 rounded-full shadow-lg z-50 hover:bg-dark transition-colors flex items-center justify-center">
