...
<body class="min-h-screen flex items-center justify-center" style="background: linear-gradient(135deg, #1E3A8A, #2563EB)">
    <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4">
        ...
        <form method="POST" action="/admin/login">
            ...
            <button type="submit" class="w-full py-3 rounded-lg text-white font-semibold transition-colors"
                style="background: #2563EB" onmouseover="this.style.background='#1E3A8A'"
        ...
        <p class="text-center text-xs text-gray-400 mt-6">
            <a href="{{ route('home') }}" class="hover:text-green-600"><i class="fas fa-arrow-left mr-1"></i> Kembali ke
                Website</a>
        </p>
    </div>
</body>
