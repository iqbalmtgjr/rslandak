...
<<<<<<< HEAD
                ...
                <select name="kategori" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    ...
                    <option value="parkir" {{ old('kategori', $item->kategori ?? 'klinik') === 'parkir' ? 'selected' : '' }}>Fasilitas Parkir</option>
                    <option value="difabel" {{ old('kategori', $item->kategori ?? 'klinik') === 'difabel' ? 'selected' : '' }}>Fasilitas Difabel</option>
                    <option value="prioritas" {{ old('kategori', $item->kategori ?? 'klinik') === 'prioritas' ? 'selected' : '' }}>Fasilitas Prioritas</option>
                </select>
            </div>
            <div>
