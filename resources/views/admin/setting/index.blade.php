    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="alamat" rows="2" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">{{ $settings['alamat'] ?? '' }}</textarea>
            </div>
            <div>
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="sambutan_direktur_teks" rows="5" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">{{ $settings['sambutan_direktur_teks'] ?? '' }}</textarea>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="md:col-span-3">
                ...
                <textarea name="meta_description" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">{{ $settings['meta_description'] ?? '' }}</textarea>
            </div>
        </div>
    </div>
