    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <img id="preview-barcode-existing" src="{{ Storage::url($settings['pengaduan_barcode']) }}" class="w-32 h-32 object-cover rounded-lg mb-2 border">
                @endif
                <img id="preview-barcode" class="w-32 h-32 object-cover rounded-lg mb-2 border hidden">
